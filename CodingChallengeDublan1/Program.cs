...
class Challenges
{
    public static void Main(string[] args)
    {
        ...
        while (run == true)
        {
            ...
            else if (choiceint == 4)
            {
                ...
                var plague = Console.ReadLine();
                int plagueint = int.Parse(plague);
                ...
                VoltConvert(plagueint, stupidityint);
            }
            else if (choiceint == 5)
            {
                Console.WriteLine("Now tell me how many years old you are so I can convert it to days");
                var urmother = Console.ReadLine();
                int urmotherint = int.Parse(urmother);

                Console.WriteLine("You are: " + Oldie(urmotherint) + " days old.");
            }
            else if (choiceint == 6)
            {
    ...
    public static int VoltConvert(int plague, int stupidity)
    {
        return plague * stupidity;
    }

    public static int Oldie(int urmother)
    {
        return urmother * 365;
    }
